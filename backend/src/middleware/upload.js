...
const MAX_FILE_SIZE = 10 * 1024 * 1024; // 10MB antes da compressão (issue #38)
...
// multer não propaga erro pro error handler global quando usado assim — sem
// isso, um arquivo grande demais ou de formato errado vira 500 em vez de um
// 400 com mensagem legível.
export function handlePrescriptionUpload(req, res, next) {
